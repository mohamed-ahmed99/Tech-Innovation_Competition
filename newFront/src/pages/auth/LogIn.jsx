...
function LogIn() {
    ...
    return (
        <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="card-redesign w-full max-w-lg !p-8 md:!p-12"
        >
            {/* title */}
            <div className="mb-10 text-center">
                <motion.h1 variants={itemVariants} className="text-3xl font-bold text-[var(--text-primary)] mb-2">Welcome back</motion.h1>
                <motion.p variants={itemVariants} className="text-[var(--text-secondary)]">Please enter your details to sign in to NeuroGaurd.</motion.p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <motion.p variants={itemVariants} className="text-center text-sm text-[var(--text-muted)] mt-6">
                    ...
                    <Link to="/auth/sign-up" className="text-[var(--accent-primary)] font-medium hover:underline ml-1">
                        Create an account
                    </Link>
                </motion.p>
            </form>
