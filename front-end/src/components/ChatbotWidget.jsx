            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-5 right-5 z-[120] w-[min(92vw,390px)] overflow-hidden rounded-2xl border border-cyan-300/20 bg-zinc-950/95 shadow-[0_16px_50px_rgba(2,6,23,0.7)] backdrop-blur-lg"
                    >
                        ...
                        <div className="border-t border-zinc-800 px-3 py-2">
                            ...
                            <form onSubmit={handleSubmit} className="flex items-center gap-2">
                                <input
                                    ...
                                    placeholder={botStatus === 'idle' ? 'Ask a question... / اكتب سؤالك' : 'NeuroGuard is typing...'}
